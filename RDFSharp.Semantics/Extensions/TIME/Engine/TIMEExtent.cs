...
namespace RDFSharp.Semantics.Extensions.TIME
{
    ...
    public class TIMEExtent : IComparable<TIMEExtent>, IEquatable<TIMEExtent>
    {
            ...
            double? hours, double? minutes, double? seconds, TIMEExtentMetadata metadata = null)
        {
            #region Guards
            if (years < 0)
                throw new OWLSemanticsException("Cannot create temporal extent because given \"years\" parameter is negative");
            if (months < 0)
                throw new OWLSemanticsException("Cannot create temporal extent because given \"months\" parameter is negative");
            if (weeks < 0)
                throw new OWLSemanticsException("Cannot create temporal extent because given \"weeks\" parameter is negative");
            if (days < 0)
                throw new OWLSemanticsException("Cannot create temporal extent because given \"days\" parameter is negative");
            if (hours < 0)
                throw new OWLSemanticsException("Cannot create temporal extent because given \"hours\" parameter is negative");
            if (minutes < 0)
                throw new OWLSemanticsException("Cannot create temporal extent because given \"minutes\" parameter is negative");
            if (seconds < 0)
                throw new OWLSemanticsException("Cannot create temporal extent because given \"seconds\" parameter is negative");
            #endregion
    ...
    public class TIMEExtentMetadata
    {
        ...
        public TIMEExtentMetadata(RDFResource trsUri)
        {
            #region Guards
            if (trsUri == null)
                throw new OWLSemanticsException("Cannot create extent metadata because given \"trsUri\" parameter is null");
            #endregion
