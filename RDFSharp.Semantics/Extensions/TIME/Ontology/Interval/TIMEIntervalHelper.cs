    ...
    public static class TIMEIntervalHelper
    {
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval is after bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval is after bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval is before bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval is before bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval contains bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval contains bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval during bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval during bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval equals bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval equals bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval finishedBy bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval finishedBy bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval finishes bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval finishes bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval in bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval in bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval meets bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval meets bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval is metBy bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval is metBy bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval overlaps bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval overlaps bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval overlappedBy bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval overlappedBy bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval starts bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval starts bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            TIMECalendarReferenceSystem calendarTRS = null)
        {
            #region Guards
            if (aTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval startedBy bInterval because given \"aTimeIntervalURI\" parameter is null");
            if (bTimeIntervalURI == null)
                throw new OWLSemanticsException("Cannot check if aInterval startedBy bInterval because given \"bTimeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
