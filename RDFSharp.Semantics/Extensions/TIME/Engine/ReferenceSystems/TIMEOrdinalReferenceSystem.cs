...
namespace RDFSharp.Semantics.Extensions.TIME
{
    ...
    public class TIMEOrdinalReferenceSystem : TIMEReferenceSystem
    {
        ...
        public TIMEOrdinalReferenceSystem DeclareEra(RDFResource era, TIMEInstant eraBeginning, TIMEInstant eraEnd)
        {
            #region Guards
            if (era == null)
                throw new OWLSemanticsException("Cannot declare era to ordinal TRS because given \"era\" parameter is null");
            if (eraBeginning == null)
                throw new OWLSemanticsException("Cannot declare era to ordinal TRS because given \"referencePoint\" parameter is null");
            if (eraEnd == null)
                throw new OWLSemanticsException("Cannot declare era to ordinal TRS because given \"eraEnd\" parameter is null");
            #endregion
        ...
        public TIMEOrdinalReferenceSystem DeclareSubEra(RDFResource era, RDFResource subEra)
        {
            #region Guards
            if (era == null)
                throw new OWLSemanticsException("Cannot declare sub-era to ordinal TRS because given \"era\" parameter is null");
            if (subEra == null)
                throw new OWLSemanticsException("Cannot declare sub-era to ordinal TRS because given \"subEra\" parameter is null");
            if (CheckHasSubEra(subEra, era, true))
                throw new OWLSemanticsException("Cannot declare sub-era to ordinal TRS because given \"era\" parameter is already defined as sub-era of the given \"subEra\" parameter, so the requested operation would generate an A-BOX inconsistency");
            #endregion
        ...
        public TIMEOrdinalReferenceSystem DeclareReferencePoint(TIMEInstant referencePoint)
        {
            ...
            if (referencePoint == null)
                throw new OWLSemanticsException("Cannot declare reference point to ordinal TRS because given \"referencePoint\" parameter is null");
            #endregion
        ...
        public bool CheckHasEra(RDFResource era)
        {
            #region Guards
            if (era == null)
                throw new OWLSemanticsException("Cannot check if ordinal TRS has era because given \"era\" parameter is null");
            #endregion
        ...
        public bool CheckHasEraBoundary(RDFResource eraBoundary)
        {
            #region Guards
            if (eraBoundary == null)
                throw new OWLSemanticsException("Cannot check if ordinal TRS has era boundary because given \"eraBoundary\" parameter is null");
            #endregion
        ...
        public bool CheckHasReferencePoint(RDFResource referencePoint)
        {
            #region Guards
            if (referencePoint == null)
                throw new OWLSemanticsException("Cannot check if ordinal TRS has reference point because given \"referencePoint\" parameter is null");
            #endregion
        ...
        public (TIMECoordinate,TIMECoordinate) GetEraCoordinates(RDFResource era, TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (era == null)
                throw new OWLSemanticsException("Cannot get coordinates of era because given \"era\" parameter is null");
            if (!CheckHasEra(era))
                throw new OWLSemanticsException("Cannot get coordinates of era because given \"era\" parameter is not a component of this ordinal TRS");
            if (calendarTRS == null)
        ...
        public TIMEExtent GetEraExtent(RDFResource era, TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (era == null)
                throw new OWLSemanticsException("Cannot get extent of era because given \"era\" parameter is null");
            if (!CheckHasEra(era))
                throw new OWLSemanticsException("Cannot get extent of era because given \"era\" parameter is not a component of this ordinal TRS");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
