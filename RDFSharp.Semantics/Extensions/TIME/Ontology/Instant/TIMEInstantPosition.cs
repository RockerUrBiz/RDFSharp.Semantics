...
namespace RDFSharp.Semantics.Extensions.TIME
{
    ...
    public class TIMEInstantPosition : RDFResource
    {
            ...
            : this(timeInstantPositionUri)
        {
            #region Guards
            if (trsUri == null)
                throw new OWLSemanticsException("Cannot create position of time instant because given \"trsUri\" parameter is null");
            #endregion
            ...
            : this(timeInstantPositionUri)
        {
            ...
            if (nominalValue == null)
                throw new OWLSemanticsException("Cannot create position of time instant because given \"nominalValue\" parameter is null");
            #endregion
