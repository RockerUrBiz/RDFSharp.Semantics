...
namespace RDFSharp.Semantics.Extensions.TIME.Test
{
    ...
    public class TIMEIntervalTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingIntervalFromDescriptionBecauseNullDescription()
            => Assert.ThrowsException<OWLSemanticsException>(() => new TIMEInterval(new RDFResource("ex:intv"), null as TIMEIntervalDescription));
        ...
        public void ShouldThrowExceptionOnCreatingIntervalFromDurationBecauseNullDuration()
            => Assert.ThrowsException<OWLSemanticsException>(() => new TIMEInterval(new RDFResource("ex:intv"), null as TIMEIntervalDuration));
        #endregion
    }
}