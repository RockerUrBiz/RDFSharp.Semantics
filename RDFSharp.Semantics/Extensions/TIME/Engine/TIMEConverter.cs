...
namespace RDFSharp.Semantics.Extensions.TIME
{
    ...
    public static class TIMEConverter
    {
        ...
        public static TIMECoordinate PositionToCoordinate(double timePosition, TIMEPositionReferenceSystem positionTRS, TIMECalendarReferenceSystem calendarTRS)
        {
            #region Guards
            if (positionTRS == null)
                throw new OWLSemanticsException("Cannot convert position to coordinate because given \"positionTRS\" parameter is null");
            if (calendarTRS == null)
                throw new OWLSemanticsException("Cannot convert position to coordinate because given \"calendarTRS\" parameter is null");
            #endregion
        ...
        public static TIMECoordinate NormalizeCoordinate(TIMECoordinate timeCoordinate, TIMECalendarReferenceSystem calendarTRS)
        {
            ...
            if (timeCoordinate == null)
                throw new OWLSemanticsException("Cannot normalize coordinate because given \"timeExtent\" parameter is null");
            if (calendarTRS == null)
                throw new OWLSemanticsException("Cannot normalize coordinate because given \"calendarTRS\" parameter is null");
            #endregion
        ...
        public static TIMEExtent DurationToExtent(double timeDuration, TIMEUnit unitType, TIMECalendarReferenceSystem calendarTRS)
        {
            #region Guards
            if (timeDuration < 0)
                throw new OWLSemanticsException("Cannot convert duration to extent because given \"timeDuration\" parameter must be greater or equal than zero");
            if (unitType == null)
                throw new OWLSemanticsException("Cannot convert duration to extent because given \"unitType\" parameter is null");
            if (calendarTRS == null)
                throw new OWLSemanticsException("Cannot convert duration to extent because given \"calendarTRS\" parameter is null");
            #endregion
        ...
        public static TIMEExtent NormalizeExtent(TIMEExtent timeExtent, TIMECalendarReferenceSystem calendarTRS)
        {
            #region Guards
            if (timeExtent == null)
                throw new OWLSemanticsException("Cannot normalize extent because given \"timeExtent\" parameter is null");
            if (calendarTRS == null)
                throw new OWLSemanticsException("Cannot normalize extent because given \"calendarTRS\" parameter is null");
            #endregion
        ...
        public static TIMEExtent CalculateExtent(TIMECoordinate timeCoordinateStart, TIMECoordinate timeCoordinateEnd, TIMECalendarReferenceSystem calendarTRS)
        {
            ...
            if (timeCoordinateStart == null)
                throw new OWLSemanticsException("Cannot get extent because given \"timeCoordinateStart\" parameter is null");
            if (timeCoordinateEnd == null)
                throw new OWLSemanticsException("Cannot get extent because given \"timeCoordinateEnd\" parameter is null");
            if (calendarTRS == null)
                throw new OWLSemanticsException("Cannot get extent because given \"calendarTRS\" parameter is null");
            #endregion
