...
namespace RDFSharp.Semantics.Extensions.TIME.Test
{
    ...
    public class TIMEInstantTest
    {
        ...
        public void ShouldThrowExceptionOnCreatingInstantFromDescriptionBecauseNullDescription()
            => Assert.ThrowsException<OWLSemanticsException>(() => new TIMEInstant(new RDFResource("ex:inst"), null as TIMEInstantDescription));
        ...
        public void ShouldThrowExceptionOnCreatingInstantFromDescriptionBecauseNullPosition()
            => Assert.ThrowsException<OWLSemanticsException>(() => new TIMEInstant(new RDFResource("ex:inst"), null as TIMEInstantPosition));
        #endregion
    }
}