...
namespace RDFSharp.Semantics.Extensions.TIME.Test
{
    ...
    public class TIMEOrdinalReferenceSystemTest
    {
        ...
        public void ShouldThrowExceptionOnDeclaringEraBecauseNullEra()
            => Assert.ThrowsException<OWLSemanticsException>(() => new TIMEOrdinalReferenceSystem(new RDFResource("ex:Thors"))
        ...
        public void ShouldCheckHasEra()
        {
            ...
            Assert.ThrowsException<OWLSemanticsException>(() => thors.CheckHasEra(null));
        }
        ...
        public void ShouldCheckHasEraBoundary()
        {
            ...
            Assert.ThrowsException<OWLSemanticsException>(() => thors.CheckHasEraBoundary(null));
        }
        ...
        public void ShouldCheckHasReferencePoint()
        {
            ...
            Assert.ThrowsException<OWLSemanticsException>(() => thors.CheckHasReferencePoint(null));
        }
        ...
        public void ShouldGetEraCoordinates()
        {
            ...
            Assert.ThrowsException<OWLSemanticsException>(() => thors.GetEraCoordinates(new RDFResource("ex:unexistingEra")));
            Assert.ThrowsException<OWLSemanticsException>(() => thors.GetEraCoordinates(null));
        }
        ...
        public void ShouldGetEraExtent()
        {
            ...
            Assert.ThrowsException<OWLSemanticsException>(() => thors.GetEraExtent(new RDFResource("ex:unexistingEra")));
            Assert.ThrowsException<OWLSemanticsException>(() => thors.GetEraExtent(null));
        }
        #endregion
    }
}
