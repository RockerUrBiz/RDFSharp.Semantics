...
namespace RDFSharp.Semantics.Extensions.TIME.Test
{
    ...
    public class TIMEOntologyTest
    {
        ...
        public void ShouldCreateTIMEOntology()
        {
            ...
            Assert.IsTrue(timeOnt.Model.ClassModel.ClassesCount == 76);
            Assert.IsTrue(timeOnt.Model.PropertyModel.PropertiesCount == 67);
            Assert.IsTrue(timeOnt.Data.IndividualsCount == 33);
        }
        ...
        public void ShouldLoadFromGraph()
        {
            ...
            Assert.IsTrue(timeOntology.Model.ClassModel.ClassesCount == 77);
            Assert.IsTrue(timeOntology.Model.PropertyModel.PropertiesCount == 69);
