...
namespace RDFSharp.Semantics.Extensions.TIME
{
    ...
    public class TIMECoordinate : IComparable<TIMECoordinate>, IEquatable<TIMECoordinate>
    {
            ...
            double? hour, double? minute, double? second, TIMECoordinateMetadata metadata=null)
        {
            #region Guards
            if (month < 0)
                throw new OWLSemanticsException("Cannot create temporal coordinate because given \"month\" parameter is negative");
            if (day < 0)
                throw new OWLSemanticsException("Cannot create temporal coordinate because given \"day\" parameter is negative");
            if (hour < 0)
                throw new OWLSemanticsException("Cannot create temporal coordinate because given \"hour\" parameter is negative");
            if (minute < 0)
                throw new OWLSemanticsException("Cannot create temporal coordinate because given \"minute\" parameter is negative");
            if (second < 0)
                throw new OWLSemanticsException("Cannot create temporal coordinate because given \"second\" parameter is negative");
            #endregion
    ...
    public class TIMECoordinateMetadata
    {
            ...
            RDFResource monthOfYear=null, RDFResource dayOfWeek=null, uint? dayOfYear=null)
        {
            #region Guards
            if (trsUri == null)
                throw new OWLSemanticsException("Cannot create coordinate metadata because given \"trsUri\" parameter is null");
            if (unitTypeUri == null)
                throw new OWLSemanticsException("Cannot create coordinate metadata because given \"unitTypeUri\" parameter is null");
            #endregion
