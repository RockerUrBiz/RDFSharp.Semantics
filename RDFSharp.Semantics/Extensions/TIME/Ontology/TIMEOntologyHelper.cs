...
namespace RDFSharp.Semantics.Extensions.TIME
{
    ...
    public static class TIMEOntologyHelper
    {
        ...
        public static OWLOntology DeclareTimeInstant(this OWLOntology timeOntology, RDFResource featureUri, TIMEInstant timeInstant)
        {
            #region Guards
            if (featureUri == null)
                throw new OWLSemanticsException("Cannot declare temporal instant to the ontology because given \"featureUri\" parameter is null");
            if (timeInstant == null)
                throw new OWLSemanticsException("Cannot declare temporal instant to the ontology because given \"timeInstant\" parameter is null");
            #endregion
        ...
        public static OWLOntology DeclareTimeInstantRelation(this OWLOntology timeOntology, TIMEInstant aTimeInstant, TIMEInstant bTimeInstant, TIMEEnums.TIMEInstantRelation timeInstantRelation)
        {
            ...
            if (aTimeInstant == null)
                throw new OWLSemanticsException("Cannot declare instant relation to the ontology because given \"aTimeInstant\" parameter is null");
            if (bTimeInstant == null)
                throw new OWLSemanticsException("Cannot declare instant relation to the ontology because given \"bTimeInstant\" parameter is null");
            #endregion
        ...
        public static OWLOntology DeclareTimeInterval(this OWLOntology timeOntology, RDFResource featureUri, TIMEInterval timeInterval)
        {
            #region Guards
            if (featureUri == null)
                throw new OWLSemanticsException("Cannot declare temporal interval to the ontology because given \"featureUri\" parameter is null");
            if (timeInterval == null)
                throw new OWLSemanticsException("Cannot declare temporal interval to the ontology because given \"timeInterval\" parameter is null");
            #endregion
        ...
        public static OWLOntology DeclareTimeIntervalRelation(this OWLOntology timeOntology, TIMEInterval aTimeInterval, TIMEInterval bTimeInterval, TIMEEnums.TIMEIntervalRelation timeIntervalRelation)
        {
            ...
            if (aTimeInterval == null)
                throw new OWLSemanticsException("Cannot declare interval relation to the ontology because given \"aTimeInterval\" parameter is null");
            if (bTimeInterval == null)
                throw new OWLSemanticsException("Cannot declare interval relation to the ontology because given \"bTimeInterval\" parameter is null");
            #endregion
        ...
        public static List<TIMEEntity> GetTemporalExtentOfFeature(this OWLOntology timeOntology, RDFResource featureUri)
        {
            #region Guards
            if (featureUri == null)
                throw new OWLSemanticsException("Cannot get temporal extent of feature because given \"featureUri\" parameter is null");
            #endregion
        ...
        public static TIMECoordinate GetInstantCoordinate(this OWLOntology timeOntology, RDFResource timeInstantURI, TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            if (timeInstantURI == null)
                throw new OWLSemanticsException("Cannot get temporal coordinate of instant because given \"timeInstantURI\" parameter is null");
            if (calendarTRS == null)
            ...
            if (timeInstant.Position != null)
            {
                ...
                else
                {
                    ...
                    if (!TIMEReferenceSystemRegistry.ContainsTRS(timeInstant.Position.TRS))
                        throw new OWLSemanticsException($"Cannot get coordinate from instant because TRS '{timeInstant.Position.TRS}' is unknown. Please register it as a positional TRS into TIMEReferenceSystemRegistry.");
                    if (TIMEReferenceSystemRegistry.Instance.TRS[timeInstant.Position.TRS.ToString()] is TIMECalendarReferenceSystem)
                        throw new OWLSemanticsException($"Cannot get coordinate from instant because TRS '{timeInstant.Position.TRS}' is required to be a positional TRS, instead it has been registered as a calendar TRS into TIMEReferenceSystemRegistry.");
                    #endregion
        ...
        public static TIMEExtent GetIntervalExtent(this OWLOntology timeOntology, RDFResource timeIntervalURI, TIMECalendarReferenceSystem calendarTRS=null)
        {
            ...
            if (timeIntervalURI == null)
                throw new OWLSemanticsException("Cannot get temporal extent of interval because given \"timeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
            ...
            if (timeInterval.Duration != null)
            {
                ...
                if (!TIMEUnitTypeRegistry.ContainsUnitType(timeInterval.Duration.UnitType))
                    throw new OWLSemanticsException($"Cannot get extent from interval because UnitType '{timeInterval.Duration.UnitType}' is unknown. Please register it into TIMEUnitTypeRegistry.");
                #endregion
        ...
        public static TIMECoordinate GetBeginningOfInterval(this OWLOntology timeOntology, RDFResource timeIntervalURI, TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (timeIntervalURI == null)
                throw new OWLSemanticsException("Cannot get beginning of interval because given \"timeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
        ...
        public static TIMECoordinate GetEndOfInterval(this OWLOntology timeOntology, RDFResource timeIntervalURI, TIMECalendarReferenceSystem calendarTRS=null)
        {
            #region Guards
            if (timeIntervalURI == null)
                throw new OWLSemanticsException("Cannot get end of interval because given \"timeIntervalURI\" parameter is null");
            if (calendarTRS == null)
                calendarTRS = TIMECalendarReferenceSystem.Gregorian;
            #endregion
        ...
        public static List<RDFResource> GetRelatedIntervals(this OWLOntology timeOntology, RDFResource timeIntervalURI, TIMEEnums.TIMEIntervalRelation timeIntervalRelation)
        {
            #region Guards
            if (timeIntervalURI == null)
                throw new OWLSemanticsException("Cannot get related intervals because given \"timeIntervalURI\" parameter is null");
            #endregion
