    ...
    public class TIMEInstant : TIMEEntity
    {
            ...
            : base(timeInstantUri)
        {
            ...
            if (timeInstantDescription == null)
                throw new OWLSemanticsException("Cannot create time instant because given \"timeInstantDescription\" parameter is null");
            #endregion
            ...
            : base(timeInstantUri)
        {
            ...
            if (timeInstantPosition == null)
                throw new OWLSemanticsException("Cannot create time instant because given \"timeInstantPosition\" parameter is null");
            #endregion
