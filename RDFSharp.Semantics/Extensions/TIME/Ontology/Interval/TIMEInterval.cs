    ...
    public class TIMEInterval : TIMEEntity
    {
            ...
            : base(timeInstantUri)
        {
            ...
            if (timeIntervalDescription == null)
                throw new OWLSemanticsException("Cannot create time interval because given \"timeIntervalDescription\" parameter is null");
            #endregion
            ...
            : base(timeInstantUri)
        {
            ...
            if (timeIntervalDuration == null)
                throw new OWLSemanticsException("Cannot create time interval because given \"timeIntervalDuration\" parameter is null");
            #endregion
            ...
            : base(timeInstantUri)
        {
            ...
            if (timeInstantBeginning == null && timeInstantEnd == null)
                throw new OWLSemanticsException("Cannot create time interval because both \"timeInstantBeginning\" and \"timeInstantEnd\" parameters are null");
            #endregion
